...
import 'package:em_chat_callkit_example/call_pages/call_button.dart';

import 'package:em_chat_callkit_example/call_pages/multi_call_item_view.dart';
import 'package:em_chat_callkit_example/call_pages/multi_call_view.dart';
import 'package:em_chat_callkit_example/contact_page.dart';
...
class _MultiCallPageState extends State<MultiCallPage> with ChatCallKitObserver {
  ...
  Future<void> afterInit() async {
    ...
    String? current = ChatCallKitClient.getInstance.currentUserId;
    list.insert(
        0,
        MultiCallItemView(
          userId: current!,
